...
<div class="col-md-4">
  <div class="card campaigns mb-4 shadow-sm">
    ...
    @endif
      <img class="card-img-top" src="{{ asset('/campaigns/small').'/'.$key->small_image }}" alt="{{ $key->title }}">
    </a>
    <div class="card-body">
    ...
    @endif
      ...
      <div class="d-flex justify-content-between align-items-center">
        <span class="text-truncate">
          <img src="{{ asset('/avatar').'/'.$key->user()->avatar }}" width="25" height="25" class="rounded-circle avatar-campaign">
